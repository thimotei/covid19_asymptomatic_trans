...
data_symp = read.csv(file = "data_symp_nishiura_20.csv", header = TRUE, sep = ",")    # raw data 
...
data_non_symp = read.csv(file = "data_non_symp_mizumoto_20.csv", header = TRUE, sep = ",") # raw data
